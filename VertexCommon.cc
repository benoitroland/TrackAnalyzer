...
void VertexCommon::GetBranches(TTree* tree,bool isData) {
...
void VertexCommon::SetBranchAddresses(TTree* tree,bool isData) {
...
void VertexCommon::GetTreeEntries(int ievt, bool isData) {
